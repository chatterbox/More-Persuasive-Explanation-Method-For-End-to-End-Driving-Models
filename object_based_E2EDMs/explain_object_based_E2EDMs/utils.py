...
def build_dataset(cross_validation_folder_path_pre, train_path, object_settings_path, action_label_csv_path):
    # print(vocab)
    # exit()
            ...
            with open(single_csv_path) as csvfile:
                ...
                for line in reader:
                    ...
                    if object_serial_num <= 5 and object_serial_num >= 1:
                        ...
                        # print(object_info, previous_img_object_info)
                        # exit()
    ...
    for i in range(5):
        ...
        test_data, max_category_num = load_dataset(cross_validation_folder_path, object_settings_path)
        test_data_list.append(test_data)
        dataset_loader_cross_validation_list.append(test_data)


    return dataset_loader_cross_validation_list, test_data_list, max_category_num
