...
class GUIclass(QWidget):
    ...
    def initUI(self, img_set_path_list, wanted_info_csv_path):
        ...
        #########################################################################################################
        # btn_allTrue = QPushButton("All True", self)
        # btn_allTrue.clicked.connect(self.AllTrue)
        # btn_allTrue.move(input_area_coord_x + x_space, input_area_coord_y)
